   ...
   <main class="site-content" id="content">
               ...
               <div class="col-md-12">
                  <div class="services-widget position-relative">
                     <div class="service-item current d-flex flex-wrap align-items-center wow fadeInUp"
                        ...
                        <div class="right-box">
                           <p>
                              We create a strong, cohesive brand identity that reflects your business values and stands out in the market. This includes logos, color schemes, typography, and overall brand strategy.
                           </p>
                        </div>
                     ...
                     <div class="service-item d-flex flex-wrap align-items-center wow fadeInUp" data-wow-delay=".6s">
                        ...
                        <div class="right-box">
                           <p>
                              We build robust, scalable websites and web applications with clean code and seamless functionality. Our development services ensure your site is fast, secure, and easy to maintain.
                           </p>
                        </div>
                        <i class="flaticon-up-right-arrow"></i>
                        <button data-mfp-src="#service-wrapper" class="service-link modal-popup"></button>
                     ...
                     <div class="service-item d-flex flex-wrap align-items-center wow fadeInUp" data-wow-delay=".7s">
                        ...
                        <div class="right-box">
                           <p>
                              We design intuitive and engaging user interfaces and experiences, making it easy for your customers to navigate and interact with your digital products.
                           </p>
                        </div>
                        <i class="flaticon-up-right-arrow"></i>
                        <button data-mfp-src="#service-wrapper" class="service-link modal-popup"></button>
                     ...
                     <div class="service-item d-flex flex-wrap align-items-center wow fadeInUp" data-wow-delay=".8s">
                        ...
                        <div class="right-box">
                           <p>
                              We create stunning visuals for your marketing materials, including brochures, advertisements, social media graphics, and more. Our designs capture attention and convey your message effectively.
                           </p>
                        </div>
                        <i class="flaticon-up-right-arrow"></i>
                        <button data-mfp-src="#service-wrapper" class="service-link modal-popup"></button>
      ...
      <div id="service-wrapper" class="popup_content_area zoom-anim-dialog mfp-hide">
         <div class="popup_modal_img">
            <img src="{{ asset('frontend/assets/img/services/modal-img.jpg') }}" alt="" />
         </div>
                  ...
                  <div class="col-lg-7 col-xl-8">
                     <div class="service_details_content">
                        <div class="service_info">
                           ...
                           <div class="desc">
                              <p>
                                 UI/UX Design: Our UI/UX design services focus on crafting exceptional digital experiences that resonate with your users. We start by understanding your target audience and their needs through comprehensive research and user analysis. 


                              </p>

                              <p>
                                 Our UI (User Interface) design ensures that every visual element, from buttons to icons, is aesthetically pleasing and aligns with your brand's identity. We prioritize intuitive navigation, creating interfaces that are not only beautiful but also easy to use.
                              </p>

                              <p>
                                 On the UX (User Experience) side, we map out the user journey to ensure a seamless and engaging experience from start to finish. This involves wireframing, prototyping, and conducting usability testing to refine the interactions and improve the overall user satisfaction. 
                              </p>
                           </div>
                           ...
                           <div class="desc">
                              <p>
                                 Our goal is to enhance the usability, accessibility, and pleasure provided in the interaction between the user and the product. By focusing on both the visual and functional aspects of design, we ensure that your digital products are not only effective but also delightful to use.
                              </p>
                           </div>
                           <ul>
